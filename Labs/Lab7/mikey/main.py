...
clock = pygame.image.load('Labs/Lab7/mikey/clock.png').convert_alpha()
min_hand = pygame.image.load('Labs/Lab7/mikey/min_hand.png').convert_alpha()
sec_hand = pygame.image.load('Labs/Lab7/mikey/sec_hand.png').convert_alpha()
