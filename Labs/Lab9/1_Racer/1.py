...
pygame.mixer.music.load("Labs/Lab8/1_racer/resources/background.wav")  # Загружаем фоновую музыку
...
#Загрузка фона
background = pygame.image.load("Labs/Lab8/1_racer/resources/AnimatedStreet.png")  # Фоновая картинка
...
coin_image = pygame.image.load("Labs/Lab8/1_racer/resources/Coin.png")       # Загрузка картинки монеты
